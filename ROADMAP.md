            ...
            * реализация
              ...
              * space map
                ...
                * `довести фичу до законченного вида`
                  ...
                  * понять как наилучшим образом должны вести себя кнопки навигации при совместном использовании
...
* двигаться дальше в исследовании принципе рекурсии
  * рекурсия элементов готова на уровне концепции knyte cloud'а
  * рекурсия knoxel space'а готова на уровне реализации прототипа
  * рекурсия отрисовки содержимого knoxel'я
    * отрисовка внутренностей без скейлов
    * введение навигации и реализация отрисовки с соответствующим ей скейлом
  * рекурсия отрисовки содержимого knoxel'я
* придумать как отрисовывать knoxel'и
  * innerspace
  * information record
  * связи
