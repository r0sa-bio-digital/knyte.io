  ...
  * пространственная навигация по пространствам knoxel'ей
    ...
    * реализация
      ...
      * поправить найденные баги
        * при добавлении knoxel'я в минусовые координаты пространства его размер раздувается 
          * потому что опимизатор размера пространства не срабатывает
          * когда в пространстве без контента есть knoxel выше и левее нуля координат
      ...
      * вынести steeringElement в глобальные переменные
