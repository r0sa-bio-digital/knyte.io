...
* доработка базовых функций навигации и управления визуализацией
  ...
  * список новых инструментов навигации на реализацию
    * базовый механизм для навигационных подпространств
      ...
      * визуально оно отображается как active bubble rect
      * повторным нажатием кнопки bubble rect размещается в выбранном месте пространства
      * для отмены размещения bubble rect'а используется escape
