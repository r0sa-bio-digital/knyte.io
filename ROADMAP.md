...
* оценка целостности логики управления пространством
  ...
  * по логике работы space map из него невозможно вытащить knoxel в другое пространство
    ...
    * `пользуясь пробелом, мы по факту делаем разновидность копирования, а не перенос`
      * поэтому результат работы пробела выглядит нелогично
    * если делать перенос односвязного knoxel'я из обычного пространства в space map
      * то он оторвётся от своего острова и станет отдельным островом со всеми вложенными в него knoxel'ями
