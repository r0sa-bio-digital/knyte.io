  ...
  * модуль запуска кода из knyte.record'ов
    ...
    * общая реализация
      ...
      * запуск подключенного кода самым простым способом
        ...
        * `с обработкой ошибок транслирования`
        * с обработкой ошибок рантайма
    * тестовая задача по рассчёту числа Пи с высокой точностью без входящих и выходящих параметров
      * базовая реализация
      ...
      * с отображением статуса интерактивного блока: ready/working
      * с отображением результата последнего вычисления: none/success/failed
    * добавление входящих и выходящих параметров
      * на примере задачи с вычислением числа Пи
        * входящий параметр - количество итераций для вычислений
        * выходящий параметр - результат вычислений
    * ещё одна тестовая задача по рассчёту другого трансцендентного числа с высокой точностью
