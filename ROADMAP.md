...
* `оценка целостности логики управления пространством`
  ...
  * насколько хорошо не показывать knoxel внутри самого себя, если он всё-таки туда вложен?
    * и надо ли вообще позволять вкладывать knoxel внутрь самого себя?
    * ссылка на код:
  ...
  * по логике работы space map из него невозможно вытащить knoxel в другое пространство
    * к примеру, пользуясь пробелом, мы по факту делаем разновидность копирования, а не перенос
    * поэтому результат работы пробела выглядит нелогично
  * не всё понятно с функцией перемещения knoxel'я
    * когда надо переместить его рядом внутри того же пространства, то всё просто и наглядно
    * при перемещении knoxel'я туда, где не виден gosted knoxel, не понятно что произошло перемещение, а не копирование
    * при отмене перемещения вдали от gosted knoxel не понятно, что он остался на старом месте, а не удалён
    * при перемещении knoxel'я в другое пространство имеем аналогичные проблемы
