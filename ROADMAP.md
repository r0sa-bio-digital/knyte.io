    ...
    * рекурсия отрисовки внутреннего пространства knoxel'я
      ...
      * отрисовка внутренностей без скейлов
        ...
        * подумать что делать при переносе ghost/bubble между пространствами
          ...
          * решение: надо создавать 2 отображения для ghost/bubble сразу во время spawn'а
            * и в каждом пространстве показывать то из отображений, которое соответствует данному пространству
          * `реализация`
