...
* реализовать отрисовку knoxel'ей
  ...
  * vector
    ...
    * `подумать что делать с изменением color, size, record для spacemap-knoxel'я`
      ...
      * багфикс - при смене цвета knoxel'я нужно менять и цветы связанных с ним кнопок spaceBack/spaceForward
  ...
  * и всё вместе в любой комбинации
    ...
    * подумать как делать назначение разных цветов стрелкам
      * по идее цвет стрелки и цвет обводки rect'а должны совпадать
        ...
        * также нужно иметь возможность менять их прозрачность
      * цвета обводок/стрелок могут быть привязаны не к knyte'у а к knoxel'ю
...
* дополнительные интерактивные knyte'ы
  ...
  * подумать есть ли возможность реализовать vectormap и spacemap на функциональности интерактивных поведений knoxel'ей
  * реализовать редакторы не только для oneline'ов, но и для многострочного форматированного текста, для кода (html/js)
