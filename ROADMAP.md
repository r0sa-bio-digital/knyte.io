...
* расширение функционала под релиз системы прототипирования модулей
  ...
  * наладить ssl для апи-сервера на https://api.knyte.io/
    * пока что работает только http://api.knyte.io/
    * сервер хостится на Heroku, и я пока не разобрался как его подружить с ssl
    * как вариант решения задачи и упрощения инфраструктуры
  ...
  * работа с группами knoxel'ей
    * реализация полноценного множественного выделения весьма трудозатратна и сложна с точки зрения дизайна
      * поэтому попробуем добиться основных эффектов с помощью пары продвинутых функций манипулирования пространствами
    * спецификация
      * перенос knoxel'ей, выбранных прямоугольной рамкой, внутрь заданного knoxel'я
        * с сохранением их относительных позиций
      * перенос knoxel'ей из выбранного knoxel'я в space root
