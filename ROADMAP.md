...
* реализовать интерактивное поведение knoxel'ей
  ...
  * оптимизация диффов в гите
    * поэкспериментировать с сортировкой блоков внутри json-файла со стейтом системы
      * для этого придётся написать кастомный JSON.stringify, но JSON.parse останется стандартной
  * тестовые задачи
