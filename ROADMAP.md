          ...
          * реализация
            ...
            * `пересмотреть весь план исходя из кратчайшего пути достажения главной цели`
              * релиз минималистичного фреймворка по логическому программированию
                * во-первых, можно отложить задачи
                ...
                * во-вторых, пора выдавать дев-версию на ревью и тестирование
            * назначение масштаба knoxel'ям
            * определение масштаба knoxel'я из active rect'а в момент создания/перемещения
