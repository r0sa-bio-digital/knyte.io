...
* расширение интерактивного функционала
  ...
  * реализовать серверный вызов run block'ов через api
    ...
    * `обеспечить возможность простой авторизации через поля header'а в запросе`
  * написать полный набор тест-кейсов для логических операторов, которые проверяют работоспособность logic-блоков во всех ситуациях
    * и демонстрируют способы их использования
