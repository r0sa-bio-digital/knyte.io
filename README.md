...
Хостинг проекта
---------------
* Официальная страница: <https://knyte.netlify.app/>
...
---------------------
* Ссылки на модули
  * Интерактивный прототип: <https://knyte.netlify.app/space/>
  ...
  * Версия в активной разработке: <https://knyte.netlify.app/space-dev/>
* Управление
